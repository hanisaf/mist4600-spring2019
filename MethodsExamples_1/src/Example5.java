...
public class Example5 {
	 ...
	 * @return tax
	 */
	public double calculateTaxWithDeductionsAndCredits(int income, int deductions, int credits) {
	...
	public static void main(String[] args) {
		...
		tax = ex.calculateTaxWithDeductionsAndCredits(income, deductions, credits);
